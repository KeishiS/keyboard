...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(                                        //
        ...
        MO(_LOWER), KC_SPC, KC_ENT, JP_MHEN, KC_NO, KC_LSFT,  //
                                                              // right
        ...
        MO(_UPPER), KC_BSPC, KC_RGUI, JP_HENK, KC_NO, KC_NO   //
        ),
    [_UPPER] = LAYOUT(                                       //
                                                             // left
